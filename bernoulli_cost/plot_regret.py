...
out_fil = "regret_1.png"
N= 50

k5 = "out_k5_N50_T1000000.txt"
k10 = "out_k10_N50_T1000000.txt"
k15 = "out_k15_N50_T1000000.txt"
k20 = "out_k20_N50_T1000000.txt"
k25 = "out_k25_N50_T1000000.txt"
k30 = "out_k30_N50_T1000000.txt"
k40 = "out_k40_N50_T1000000.txt"
k50 = "out_k50_N50_T1000000.txt"

files = [k5, k10, k15, k20, k25, k30, k40, k50]
reg = []
####################################
...
plt.plot(ind, reg[1], label='k = 10')
plt.plot(ind, reg[2], label='k = 15')
plt.plot(ind, reg[3], label='k = 20')
plt.plot(ind, reg[4], label='k = 25')
plt.plot(ind, reg[5], label='k = 30')
plt.plot(ind, reg[6], label='k = 40')
plt.plot(ind, reg[7], label='k = 50')
plt.legend()
